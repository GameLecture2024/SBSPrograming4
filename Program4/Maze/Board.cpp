...
void Board::Kruskal()
{
	...
	// TODO : 점점 연결하는 (WALL) 간선. 비용. 랜덤 설정하겠다.
	struct CostEdge
	{
		bool operator<(CostEdge& other) { return cost < other.cost; }
	...
	// u - v  => Pos데이터 파싱. disJoint int  Pos => int 변환한다Parse
	// 5,5 =>  5 +5 = 10;	(0,5) (5,0) 5 5	   (4,6)
	// heap. parent = [i/2]+1
	// y의값 곱하기 x 더하기
...
void Board::Prim()
{
	...
	// 다익스트라 비슷. 프림. 비용을 길마다 최적의 방법을 Best 저장. 
	// map - 이진트리 균형잡힌 (레드블랙트리)
